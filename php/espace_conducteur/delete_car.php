...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['num_immatricule'])) {
    ...
    if ($confirm_delete === 'yes') {
        ...
        if ($stmt1->execute()) {
            ...
            echo "Voiture correctement supprimée. Attention, toutes les informations en relation avec cette voiture ont été supprimées.";
        } else {
        ...
        echo "Suppression annulée. La voiture n'a pas été supprimée.";
    } else {
